  ...
  return (
    <div className="dashboard-grid">
      <div className="feed-column" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        <div style={{ background: '#0f172a', padding: '1rem', borderRadius: 'var(--radius-md)', border: '1px solid rgba(255,255,255,0.05)' }}>
          <h2 style={{ fontSize: '1.2rem', fontWeight: '700', marginBottom: '1rem', color: '#f8fafc', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
